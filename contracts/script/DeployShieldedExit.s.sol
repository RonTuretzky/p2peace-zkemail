...
contract DeployShieldedExit is Script {
    // FIELD-REDUCED (keccak % BN254 field) — must match the real zkEmail proof's public
    // signals (zk/gen-prov-proof.mjs) and Bit2C's real Poseidon pubkey hash.
    bytes32 internal constant EXIT_PATTERN =
        0x17daa3536d3be8aebd6b203501d3d891e0f5aa96909f83ee95e478478f70bcca;
    bytes32 internal constant BIT2C =
        0x2215428844edb4087ef410b13fae8aeb64b182360b58fa0330042a23c702bca2;
    bytes32 internal constant BIT2C_KEYHASH =
        0x2abbcd9ba2b93180848a7bf4098994facf33ad8afada2e6f87e6980d6aca2eed;
    ...
    ProvenanceGroth16Verifier internal provG16;
    ProvenanceVerifierAdapter internal provAdapter;
    ...
    function run() external {
        ...
        provG16 = new ProvenanceGroth16Verifier();
        provAdapter = new ProvenanceVerifierAdapter(provG16);
        ...
        // REAL zkEmail provenance verifier (no mock) + Bit2C's real Poseidon key hash.
        zk.setVerifier(EXIT_PATTERN, IGroth16Verifier(address(provAdapter)));
    ...
    function _log(address hasher) internal view {
        ...
        console2.log("ProvenanceGroth16Verifier:", address(provG16));
        console2.log("ProvenanceVerifierAdapter:", address(provAdapter));
