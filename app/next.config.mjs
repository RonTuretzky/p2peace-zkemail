...
// The Decentral Park kit re-exports its Navbar, which pulls in Privy's full
// bundle. We use general (wallet) auth, not Privy, so Privy's optional wallet
// integrations are never reached at runtime — stub the ones that aren't
// installed so the bundler doesn't fail resolving them.
